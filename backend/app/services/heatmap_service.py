...
class HeatmapGenerator:
    ...
    def generate_heatmap(self, request: HeatmapRequest, kp_index: float) -> Dict[str, Any]:
            ...
            for j in range(len(lons) - 1):
                ...
                feature = geojson.Feature(
                    ...
                    properties={
                        ...
                        "gps_error_min": self.risk_service.estimate_gps_error(risk_level, center_lat)[0],
                        "gps_error_max": self.risk_service.estimate_gps_error(risk_level, center_lat)[1]
                    }
                )
